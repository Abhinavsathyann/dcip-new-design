    ...
    <section className="py-16 md:py-32 bg-slate-50 overflow-hidden">
      <Container>
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Image - Visible on all screens now with responsive height */}
          <div className="relative h-[300px] md:h-[500px] lg:h-[700px] w-full rounded-2xl overflow-hidden shadow-2xl order-first lg:order-none">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif leading-[1.15] text-slate-900 mb-8 md:mb-12">
            ...
            <div className="flex justify-center md:justify-end">
              <div className="max-w-md text-left">
                <p className="text-slate-500 text-base md:text-lg leading-relaxed text-center md:text-left">
